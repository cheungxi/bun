...
__asm__(".symver expf,expf@GLIBC_2.36");
__asm__(".symver exp,exp@GLIBC_2.36");
__asm__(".symver exp2,exp2@GLIBC_2.36");
__asm__(".symver log,log@GLIBC_2.36");
__asm__(".symver log2,log2@GLIBC_2.36");
__asm__(".symver log2f,log2f@GLIBC_2.36");
__asm__(".symver logf,logf@GLIBC_2.36");
__asm__(".symver pow,pow@GLIBC_2.36");
__asm__(".symver powf,powf@GLIBC_2.36");
#endif
